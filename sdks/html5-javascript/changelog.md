...
- Moved Entities and Collections functionality into a separate file (extensions/usergrid.entity-collection.js). Include this file after the the SDK if you want to use these objects.
