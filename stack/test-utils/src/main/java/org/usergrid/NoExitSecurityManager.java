...
/**
 * Used to prevent System.exit() calls when testing funky Cassandra
 * exit code and race conditions in the ForkedBooter from Maven's
 * Surefire plugin. Use this as a tool to find out where some issues
 * may arise.
 */
