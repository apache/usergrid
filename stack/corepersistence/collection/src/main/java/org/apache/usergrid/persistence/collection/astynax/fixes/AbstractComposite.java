...
public abstract class AbstractComposite extends AbstractList<Object> implements Comparable<AbstractComposite> {
    ...
    public static final BiMap<Class<? extends Serializer>, String>
            DEFAULT_SERIALIZER_TO_COMPARATOR_MAPPING = new ImmutableBiMap.Builder<Class<? extends Serializer>, String>()
    ...
    static final ImmutableClassToInstanceMap<Serializer>
            SERIALIZERS = new ImmutableClassToInstanceMap.Builder<Serializer>()
