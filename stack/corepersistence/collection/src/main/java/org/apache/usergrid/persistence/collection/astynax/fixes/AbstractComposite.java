...
/**
 * Parent class of Composite and DynamicComposite. Acts as a list of objects that get serialized into a composite column
 * name. Unless setAutoDeserialize(true) is called, it's going to try to match serializers to Cassandra comparator
 * types.
 *
 * @author edanuff
 */
...
public abstract class AbstractComposite extends AbstractList<Object> implements Comparable<AbstractComposite> {
    ...
    public static final BiMap<Class<? extends Serializer>, String> DEFAULT_SERIALIZER_TO_COMPARATOR_MAPPING =
    ...
    public static final BiMap<Byte, String> DEFAULT_ALIAS_TO_COMPARATOR_MAPPING =
            new ImmutableBiMap.Builder<Byte, String>().put( ( byte ) 'a', ComparatorType.ASCIITYPE.getTypeName() )
    ...
    private Serializer<?> serializerForComparator( String c ) {
        ...
        if ( ComparatorType.LEXICALUUIDTYPE.getTypeName().equals( c ) || ComparatorType.TIMEUUIDTYPE.getTypeName()
                                                                                       .equals( c ) ) {
