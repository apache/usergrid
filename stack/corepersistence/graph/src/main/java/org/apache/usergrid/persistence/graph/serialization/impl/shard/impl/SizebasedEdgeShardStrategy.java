...
public class SizebasedEdgeShardStrategy implements EdgeShardStrategy {
    ...
    @Override
    public long getWriteShard( final Id rowKeyId, final UUID version, final String... types ) {
        return 0;  //To change body of implemented methods use File | Settings | File Templates.
    }


    @Override
    public Iterator<Long> getReadShards( final Id rowKeyId, final UUID maxVersion, final String... types ) {
