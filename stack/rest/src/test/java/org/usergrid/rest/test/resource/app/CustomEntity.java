...
/**
 * A resource for testing entities
 * 
 * @author tnine
 *
 */
public class CustomEntity extends EntityResource {

  /**
   * @param entityId
   * @param parent
   */
  public CustomEntity(UUID entityId, NamedResource parent) {
   ...
   * @param parent
   */
  public CustomEntity(String entityName, NamedResource parent) {
