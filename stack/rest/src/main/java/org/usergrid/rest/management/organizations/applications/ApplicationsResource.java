...
public class ApplicationsResource extends AbstractContextResource {
	...
	@GET
	public ApiResponse getOrganizationApplications(@Context UriInfo ui)
			throws Exception {
	...
	public ApplicationResource deleteApplicationFromOrganizationByApplicationId(
			@Context UriInfo ui, @PathParam("applicationId") String applicationIdStr)
			throws Exception {
	...
	public ApplicationResource deleteApplicationFromOrganizationByApplicationName(
			@Context UriInfo ui,
			@PathParam("applicationName") String applicationName) throws Exception {

		ApplicationInfo application = management.getApplication(applicationName);
