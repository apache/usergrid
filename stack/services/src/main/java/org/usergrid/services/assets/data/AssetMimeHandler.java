...
public final class AssetMimeHandler
{
    ...
    /**
     * Get the Mime type of an Asset based on it's type. If the Asset already has the "content-type" property set, we
     * return that. Otherwise the mimeutil library is used to do file type detection.
     *
