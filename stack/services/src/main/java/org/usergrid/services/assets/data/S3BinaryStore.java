...
public class S3BinaryStore implements BinaryStore
{
    ...
    final static Iterable<? extends Module> MODULES = ImmutableSet
        ...
        try
        {
            ...
            if ( copied == FIVE_MB )
            {
                ...
                try
                {
                    ...
                    bb = blobStore.blobBuilder( AssetUtils.buildAssetKey( appId, asset ) ).payload( f ).calculateMD5()
            ...
            else
            {
                ...
                copied = data.length;
                bb = blobStore.blobBuilder( AssetUtils.buildAssetKey( appId, asset ) ).payload( data ).calculateMD5()
