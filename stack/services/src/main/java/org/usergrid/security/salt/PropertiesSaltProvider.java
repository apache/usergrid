...
/**
 * Simple implementation that uses applicationId as a key to lookup a salt value from a properties file.<br/>
 * The file must be loaded via spring, and injected into this bean
 * 
 * @author tnine
 *
 */
