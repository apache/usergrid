...
public class OrganizationConfig {
    ...
    public OrganizationConfig(OrganizationConfigProps configFileProperties, UUID id, String name, Map<Object, Object> newOrgProperties,
                              boolean validateOrgProperties) throws IllegalArgumentException {
    ...
    public void addProperties(Map<String, Object> newOrgProperties, boolean validateOrgProperties) throws IllegalArgumentException {
    ...
    public Map<String, Object> getOrgConfigDefaultsMap() {
        return getOrgConfigCustomMap(null, true, false);
    }
    ...
    public Map<String, Object> getFilteredOrgConfigDefaultsMap(Set<String> items) {
        return getOrgConfigCustomMap(items, true, false);
    }
