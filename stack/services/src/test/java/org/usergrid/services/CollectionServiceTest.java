...
public class CollectionServiceTest extends AbstractServiceTest {
	...
	public void testGenericEntityCollectionWithIdName() throws Exception {
        ...
        UUID applicationId = createApplication("testOrganization", "testCatsDogs");
        ...
        Entity cat = testRequest(sm, ServiceAction.POST, 1, properties,
                "cats").getEntity();
        assertNotNull(cat);
        ...
        Entity dog = testRequest(sm, ServiceAction.POST, 1, properties,
                "dogs").getEntity();
        assertNotNull(dog);
