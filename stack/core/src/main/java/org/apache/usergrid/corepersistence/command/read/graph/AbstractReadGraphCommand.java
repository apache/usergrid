 ...
 */
public abstract class AbstractReadGraphCommand extends AbstractCommand<Id, Edge> implements TraverseCommand {
     ...
     */
    public AbstractReadGraphCommand( final GraphManagerFactory graphManagerFactory ) {
