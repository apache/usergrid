...
/**
 * Compares 2 entity location refs by distance.  The one with the larger distance is considered greater than one with a smaller distance.  If the distances are the same
 * they time uuids are compared based on the UUIDUtils.compare for time uuids.  The one with a larger time is considered greater 
 * @author tnine
 * 
 */
