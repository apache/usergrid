...
public class RunsChartLayoutNew extends ChartLayoutNew {
    ...
    public RunsChartLayoutNew( Params params, TabSheetManager tabSheetManager ) {
    ...
    protected void nextChartButtonClicked() {
        AbsoluteLayout layout = new IterationsChartLayoutNew( getParams() );
