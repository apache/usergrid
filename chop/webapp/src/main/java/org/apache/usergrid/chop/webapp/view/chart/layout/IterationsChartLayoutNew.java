...
public class IterationsChartLayoutNew extends ChartLayoutNew {
    ...
    public IterationsChartLayoutNew( Params params ) {
        super( InjectorFactory.getInstance( IterationsChartBuilder.class ), "iterationsChart", "js/iterations-chart.js", params );
    }
