...
public class HourlySessionMetricsChartServiceTest extends TestCase
{
	...
	public void testGetHourlyChartDataActiveSessions() {
	...
	public void testGetAggregateSessionData() {
	...
	public void testGetHourlySessionMetricsForYesterday() {
	...
	public void testSummarySessionForDevices() {
		ServiceFactory.getSessionChartCriteriaService().saveChartCriteria(TestUtil.getActiveSessionChartCriteriaForHourly());
	...
	public void testDistinctDeviceModel() {

		ServiceFactory.getSessionChartCriteriaService().saveChartCriteria(TestUtil.getActiveSessionChartCriteriaForHourly());
		Calendar time = Calendar.getInstance();
		time.add(Calendar.MINUTE, -15);
		SummarySessionTestData.populateSummarySessionDataForMinutes(10, (Calendar) time.clone() ,5, 1L);

		time.add(Calendar.MINUTE, 5);
		List <String> list = ServiceFactory.getSessionDBService().getDistinctValuesFromSummarySessionMetrics("deviceModel", time.getTime());
		System.out.println(list);
		assertTrue("there are some summmary device models " , list.size() > 0);

	}

	public void testEnvironmentOverrideUpdate()  {
		ServiceFactory.getSessionChartCriteriaService().saveChartCriteria(TestUtil.getActiveSessionChartCriteriaForHourly());
		Calendar time = Calendar.getInstance();
		time.add(Calendar.MINUTE, -15);
		SummarySessionTestData.populateSummarySessionDataForMinutes(10, (Calendar) time.clone() ,5, 1L);
		try {
			...
			new EnvironmentOverrideValueUpdater().execute(null);
