...
public class PopulateSessionTestData
{
   ...
   public static void main(String[] args) {      
      ...
      System.out.println("Populating session test data for app1 and app2");
      ...
      startTime.add(Calendar.HOUR_OF_DAY, -1); // for the last 1 hour
      
      // startTime.add(Calendar.DAY_OF_MONTH, -1); // for yesterday
      // startTime.add(Calendar.DAY_OF_MONTH, -7); // for last week
      
      SessionTestData.populateSessionDataForMinutes(200, startTime,5, app1.getInstaOpsApplicationId());
      SessionTestData.populateSessionDataForMinutes(200, startTime,5, app2.getInstaOpsApplicationId());
      
      SummarySessionTestData.populateSummarySessionDataForMinutes(200, startTime,5, app1.getInstaOpsApplicationId());
      SummarySessionTestData.populateSummarySessionDataForMinutes(200, startTime,5, app2.getInstaOpsApplicationId());
